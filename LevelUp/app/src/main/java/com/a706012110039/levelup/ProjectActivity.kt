...
class ProjectActivity : AppCompatActivity() {
    ...
    private fun dummydata(){
        ...
        tasks.add(task("Make Project Prototype","An accurate prototype to pitch investors","date","Everyone","N"))
        tasks.add(task("Make Project BMC","BMC and Project idea plans","date","Everyone","Y"))
